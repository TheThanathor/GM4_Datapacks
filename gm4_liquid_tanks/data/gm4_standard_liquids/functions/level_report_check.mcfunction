...
#max 30970 (xp)
execute if score @e[type=marker,tag=gm4_liquid_tank,distance=..0.1,limit=1] gm4_lt_max matches 30970 run function gm4_standard_liquids:level_report/experience
