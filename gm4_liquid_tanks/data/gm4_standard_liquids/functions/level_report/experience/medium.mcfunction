...
scoreboard players remove gm4_lt_report_calc gm4_lt_value 196
scoreboard players operation gm4_lt_report_calc gm4_lt_value *= #10 gm4_lt_value
scoreboard players operation gm4_lt_report_calc gm4_lt_value /= #25 gm4_lt_value
...
scoreboard players add gm4_lt_report_calc gm4_lt_value 8
