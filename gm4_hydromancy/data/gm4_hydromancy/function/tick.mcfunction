...
execute at @a[tag=gm4_hy_using_spell_trident] as @e[type=trident,distance=..4,nbt={item:{components:{"minecraft:custom_data":{gm4_hy_spell_trident:{}}}}},tag=!gm4_hy_spell_trident.init] at @s run function gm4_hydromancy:spell_trident/thrown
