...
execute store result entity @s item.components."minecraft:custom_data".gm4_hy_spell_trident.mana.left int 1 run scoreboard players operation @s gm4_hy_charge -= @s gm4_hy_mana_used
...
execute store result score $mana_max gm4_hy_data run data get entity @s item.components."minecraft:custom_data".gm4_hy_spell_trident.mana.max
...
execute store result entity @s item.components."minecraft:custom_data".gm4_hy_spell_trident.dura int 1 run scoreboard players get $mana gm4_hy_data
...
execute store result entity @s item.components."minecraft:custom_data".Damage int 1 run scoreboard players operation $durability gm4_hy_data -= $mana gm4_hy_data
