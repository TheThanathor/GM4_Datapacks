...
execute if entity @s[tag=gm4_hy_spell_trident.landed,tag=gm4_hy_spell_trident.process] run particle block{block_state:"water"} ~ ~0.75 ~ 0.475 0.175 0.475 0 32
...
particle block{block_state:"water"} ~ ~ ~ 0.175 0.175 0.175 0 8
