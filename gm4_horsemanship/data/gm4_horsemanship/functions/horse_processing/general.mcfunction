...
## | Nether Portal
# this allows players on gm4_horses to go through nether portals without having to dismount
execute if score @s gm4_horse_portal matches -2147483648..2147483647 unless block ~ ~ ~ nether_portal run function gm4_horsemanship:riding/portal/reset_horse
execute unless score @s gm4_horse_portal matches ..-1 unless score @s gm4_horse_portal matches 6.. if block ~ ~ ~ nether_portal run function gm4_horsemanship:riding/portal/process
...
## | Brushing
# cap of 750
# brushed = +750 (can only brush when brushing is at 0, marked with dirt particles)
# saddled = -1
# riding = -1
execute if score $saddled gm4_horse_data matches 1 run scoreboard players remove @s[scores={gm4_horse_brushed=1..}] gm4_horse_brushed 1
...
execute if score $mounted gm4_horse_data matches 0 unless score @s gm4_horse_brushed matches 1.. run scoreboard players remove @s gm4_horse_need.care 5
