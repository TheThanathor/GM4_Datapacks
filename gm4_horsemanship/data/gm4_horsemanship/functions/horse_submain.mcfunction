...
execute if score @s[tag=gm4_horse.tired] gm4_horse_need.graze matches 1.. if score @s gm4_horse_need.care matches 1.. if score @s gm4_horse_need.stamina matches 30.. run function gm4_horsemanship:riding/stamina/rested
